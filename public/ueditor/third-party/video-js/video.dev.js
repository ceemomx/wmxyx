...
vjs.Button.prototype.createEl = function(type, props){
  // Add standard Aria and Tabindex article
  props = vjs.obj.merge({
...
/**
 * Add a text track
 * In addition to the W3C settings we allow adding additional article through options.
...
vjs.TextTrack = vjs.Component.extend({
  ...
  init: function(player, options){
    ...
    // Apply track article to track object
